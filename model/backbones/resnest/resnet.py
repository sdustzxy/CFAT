...
def resnet50(pretrained=False, root='~/.encoding/models', **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(resnest_model_urls['resnet50'],
                                               progress=True,
                                               check_hash=True))
    return model
...
def resnet101(pretrained=False, root='~/.encoding/models', **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(resnest_model_urls['resnet101'],
                                               progress=True,
                                               check_hash=True))
    return model
...
def resnet152(pretrained=False, root='~/.encoding/models', **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            torch.hub.load_state_dict_from_url(resnest_model_urls['resnet152'],
                                               progress=True,
                                               check_hash=True))
    return model
